    ...
    return (
        <div key={movie.id} className={styles.myMovie}>
            ...
            <div className={styles.buttons}>
                <Link href={moviePath(movie.id)}><button className={styles.button_play}><span style={{marginRight: '2px'}}>Play</span><img src="/images/play.png" alt="play-img" style={{width: '12px', marginTop: '2px'}} /></button></Link>
