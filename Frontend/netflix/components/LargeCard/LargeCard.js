...
import {moviePath} from '../../utils/strings'
    ...
    return (
        ...
        >
            ...
            <div className={styles.buttons}>
                <Link href={moviePath(movie.id)}><button  className={styles.button}><img className={styles.icon} src="/images/play_white.png" alt="play" /></button></Link>
                ...
                <button onClick={() => likeMovie(movie,state.authUser.user.liked, state.authUser.user.disliked)} className={styles.button}><img className={styles.icon} src="/images/like.png" alt="like" /></button>
                <button onClick={() => dislikeMovie(movie,state.authUser.user.disliked, state.authUser.user.liked)} className={styles.button}><img className={styles.icon} src="/images/dislike.png" alt="dislike" /></button>
            </div>
