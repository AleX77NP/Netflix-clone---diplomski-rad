    ...
    return (
        <AuthLayout>
            <div className={styles.body}>
                ...
                { state.authUser?.user.watchlist && state.authUser.user.watchlist.length === 0 && <p style={{color: 'white', fontSize: '28px', display: 'block', margin: 'auto', marginTop: '100px', textAlign: 'center'}}>Watchlist is empty</p>}
